...
public:
    ...
    struct RouteInternalData {
        bool operator==(const RouteInternalData &rhs) const {
            return weight == rhs.weight &&
                   prev_edge == rhs.prev_edge;
        }
...
public:
    ...
    typename Router<Weight>::RoutesInternalData& GetMutableInternalData();
...
std::optional<typename Router<Weight>::RouteInfo> Router<Weight>::BuildRoute(VertexId from,
    ...
    template<typename Weight>
    void Router<Weight>::SetGraph(Router::Graph *graph) {
        graph_ = graph;
    }

    template<typename Weight>
    typename Router<Weight>::RoutesInternalData& Router<Weight>::GetMutableInternalData() {
        return routes_internal_data_;
    }
